...
import { fetchLikes, Post, Photo } from './posts';
import { List, WindowScroller, InfiniteLoader, CellMeasurer, CellMeasurerCache } from 'react-virtualized';
...
const SUPPORTED_POST_TYPES = new Set([ "photo", "text" ]);
...
export class App extends React.Component<{}, AppState> {
    ...
    public componentDidMount() {
        ...
        this.setState({ width: isPortrait ? window.innerWidth : window.innerWidth / 3 });
    }

    public render = () => <div style={styles.body}>
        {navBar(this.posts.length, () => { if (this.list) {
    ...
    private async loadLikes() {
        ...
        const { response: { _links: links, liked_posts: new_likes } } = { ...fetchResult };
